...
const Cart = (props) => {
    ...
    const fetchCart = async () => {
        const result = await fetch(`https://pos-server-ls88.onrender.com/cart`)      // change to final deployment site
        result
            .json()
    ...
    const addDishToCart = async (event) => {
        ...
        const response = await fetch('https://pos-server-ls88.onrender.com/add_dish_to_cart', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
